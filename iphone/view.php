...
$sql = "SELECT id, userid, data FROM dataphone ORDER BY id DESC";
		...
		<div class="pecen80" id="case-important">
			...
			<?php 
					...
					if($content != ''){ 
						...
						//for($i =0;$i<1;$i++){
							echo "<div style='position: relative;top:10px;font-size: 13px;line-height:35px;'> User:". $content[$i]['userId'] ." - Device: ". $content[$i]['device']."  </div>";
